...
class Dehydrator(object):
    ...
    def solve(self,input):
        ...
        self._Dehy_caoh2_in = input["Dehy_caoh2_in"]
       ...
       # dehydrator(self, Ti_flue_gas, Ti_cao, Ti_water,To_water,Tcarb, pcarb, X):
        dehydrator = self.dehydrator(self._Dehy_caoh2_in,
                                             self._T_dehy,
                                             self._P_amb,
        ...
        evaluation_indicators,Caes = self.evaluation_indicators(results,input["cn_m1"])
