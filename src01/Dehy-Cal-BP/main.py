...
if __name__ == '__main__':
    ...
    inputs["p_Dehy"]=best_vars[0,2]
    inputs["t_HEN"] = best_vars[0,3] #变量4，反应器压力
    inputs["m_water"] = best_vars[0,4] #变量2，脱水反应器过热温度
    inputs["Dehy_overheating_temperature"] = best_vars[0,5]

    inputs["p_bray_H_B"] = best_vars[0,6]
    inputs["p_bray_MH_B"] = best_vars[0,7]
    inputs["p_bray_ML_B"] = best_vars[0,8]

    inputs["p_Hydr"] = best_vars[0,9]
    inputs["R"] = best_vars[0,10]
    inputs["HT"] = best_vars[0,11]
    inputs["H_out"] = best_vars[0,12]#补充烟气
