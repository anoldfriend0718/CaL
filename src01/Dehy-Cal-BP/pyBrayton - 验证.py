...
class Brayton(object):
    ...
    def solve(self,a,inputs):
        ...
        results = {}
        #Basic input data
        self._t_reaction_B = inputs["HT"]+self._min_temperature_exchange
        ...
        t_h_out=results["B_primary_compressor"]["t_compressor_out"]+5
        #低温回热器
        Low_recovery=self.l_recovery_h(self.H_out,
                                                     t_h_out,
                                                     self._p_bray_L_B,
                                                     self._p_bray_H_B/0.99)
    ...
    def compressor(self, T_in, P_in, P_out):
        ...
        p_compressor_in = P_in*0.99
        p_compressor_out = P_out/0.99
    ...
    def turbine(self, T_in,P_in,P_out):
        t_turbine_in = T_in
        p_turbine_in = P_in*0.9735
        p_turbine_out = P_out/0.99
    ...
    def h_exchanger(self,T_in,T_out,P):
        ...
        P1 = P*0.9735
        h_h_exchanger_in =CP.PropsSI('H', 'T', t_h_exchanger_in+273.15,  'P', P1, "REFPROP::co2")
        h_h_exchanger_out=CP.PropsSI('H', 'T', t_h_exchanger_out+273.15, 'P', P1, "REFPROP::co2")
        hot_out_h_exchanger=h_h_exchanger_in-h_h_exchanger_out
        results = {}
        results["t_h_exchanger_out"] = t_h_exchanger_out
        results["p_h_exchanger_out"] = P*0.9735
...
if __name__ == '__main__':
    ...
    parameters["isentropic_eff_mc"] = 0.9  #等熵效率
    parameters["t_isentropic_eff_mc"] = 0.92
    parameters["mechanical_eff"] = 1   #机械效率
    parameters["min_temperature_exchange"] = 14
