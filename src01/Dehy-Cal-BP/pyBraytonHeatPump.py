...
class BraytonHeatPump(object):
    ...
    def heat_recovery(self, T_in,P):
        ...
        if T_in+self._min_temperature_exchange>=105 :
            ...
            t_flue_gas_out = 105
        h_flue_gas_in = CP.PropsSI('H', 'T', t_flue_gas_in+273.15, 'P', 6.3e5 , "REFPROP::water")
        h_flue_gas_out = CP.PropsSI('H', 'T', t_flue_gas_out+273.15, 'P', 6.3e5 , "REFPROP::water")
    ...
    def evaluation_indicators(self,results,P_in):
        ...
        eva["flue_gas_mass_flow"] = eva["mass_flow"]*results["heat_recovery"]["n"]/44*18
